...
def buildChronoList(TimePhraseList, chrono_id, ref_list, PIclassifier, PIfeatures, bert_model, bert_tokenizer, bert_classifier, includeContext, includeAttention, dct=None):
    chrono_list = []
    ...
    for s in TimePhraseList:
       ...
       # if len(chrono_tmp_list) > 0:
        ...
        if len(tmplist) > 0:
            ...
            s.getISO(tmplist, bert_model, bert_tokenizer, bert_classifier, includeContext, includeAttention)
