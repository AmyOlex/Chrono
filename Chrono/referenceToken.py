...
class refToken:
    ...
    ## The constructor
    def __init__(self, id, text, start_span=None, end_span=None, pos=None, temporal=None, numeric=None,
...
def convertToRefTokens(tok_list, id_counter=0, span=None, pos=None, temporal=None, remove_stopwords=None,
    ...
    for idx in range(0, tok_len):
        ref_list.append(refToken(id=id_counter, text=tok_list[idx],
                                 start_span=span[idx][0] if include[1] else None,
                                 ...
                                 sent_membership=sent_membership[idx] if include[6] else None))
