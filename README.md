...
### Roles and Contributions
 - *Amy Olex:* Team lead, workflow development lead, framework implementation, run_task6.py author, temporalEntityty.py 
...
program flotemporalEntity.pyty.pypy" is the class file that defines a SUTime entity object; "chronoentity.py" is the class file 
that defines all possible annotation types described by Bethard and Parker; "TimePhrase_to_Chrono.py" is the primary method 
...
GUTime phrases were converted to chrono entities and evaluated against the gold standard using the AnaforaTools package. Each input file was run with GUTimeTimePhrase_to_Chrono.py
