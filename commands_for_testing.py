...
# load in BERT model
bert_model = BertModel.from_pretrained("/Users/alolex/Desktop/CCTR_Git_Repos/PycharmProjects/ChronoBERT/models/bert2chrono_seq2seq_BIO_4epochs_pretrained", output_hidden_states=True, use_cache=True, output_attentions=True)
bert_tokenizer = BertTokenizer.from_pretrained("/Users/alolex/Desktop/CCTR_Git_Repos/PycharmProjects/ChronoBERT/models/bert2chrono_seq2seq_BIO_4epochs_pretrained")
