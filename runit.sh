...
#python -m anafora.evaluate -r ../data/Debugging/gold/ -p ../resultsDebug/ --exclude Event After Before Between Frequency Union Modifier This Intersection NthFromStart --per-document
