...
#python run_chrono.py -i ./data/SemEval-Task6-Test/ -r ./data/SemEval-Task6-TestGold/ -o ./resultsTest/ -m $ML -d "./official_train_MLmatrix_012618_data.csv" -c "./official_train_MLmatrix_012618_class.csv"
...
#python run_chrono.py -i ./data/SemEval-Task6-Train/ -r ./data/SemEval-Task6-TrainGold/ -o ./resultsTrain/ -m $ML -d "./official_train_MLmatrix_012618_data.csv" -c "./official_train_MLmatrix_012618_class.csv"
...
#python run_chrono.py -i ./data/SemEval-OfficialTrain/ -r ./data/SemEval-OfficialTrain/ -o ./resultsOfficialTrain -t "official_train_MLmatrix_012618" -w 3
